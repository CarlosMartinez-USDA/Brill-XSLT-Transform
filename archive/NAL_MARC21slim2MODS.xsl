<xsl:stylesheet xmlns="http://www.loc.gov/mods/v3" xmlns:marc="http://www.loc.gov/MARC21/slim"
	...
	MARC21slim2MODS3-4 (Revision 1.77) 20120323

Revision 1.77 - Fixed 852 mapping <shelfLocation> was changed to <shelfLocator> - 2012/03/23 tmee
...
-->
		...
		<recordInfo>
			...
			<xsl:for-each select="marc:datafield[@tag=040]">
				...
				<recordContentSource authority="oclcorg"> <!-- Changed from marcorg 2013-07-22 CWS-->
					<xsl:value-of select="marc:subfield[@code='a']"/>
				</recordContentSource>
			</xsl:for-each>
			<xsl:for-each select="marc:controlfield[@tag=008]">
			...
			<recordOrigin>Converted from MARCXML to MODS version 3.4 using MARC21slim2MODS3-4.xsl (Revision 1.77 2012/03/23)</recordOrigin>
