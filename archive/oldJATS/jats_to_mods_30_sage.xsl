        ...
        <relatedItem type="host">
            ...
            <part>
                ...
                <xsl:if test="/article/front/article-meta/pub-date[@pub-type='epub']/season" >
                    ...
                    <xsl:if test="/article/front/article-meta/pub-date[@pub-type='epub-ppub']/year" > 
                        <text type="year">   
                            <xsl:value-of select="/article/front/article-meta/pub-date[@pub-type='epub-ppub']/year" />
                        </text>
                </xsl:if>
                <xsl:if test="/article/front/article-meta/pub-date[@pub-type='epub-ppub']/month" > 
                    <text type="month">   
                        <xsl:value-of select="/article/front/article-meta/pub-date[@pub-type='epub-ppub']/month" />
                    </text>
                </xsl:if>
                <xsl:if test="/article/front/article-meta/pub-date[@pub-type='epub-ppub']/day" > 
                    <text type="day">   
