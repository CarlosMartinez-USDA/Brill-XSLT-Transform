    ...
    <xsl:template name="dateIssued">
        <originInfo>
            <dateIssued encoding="w3cdtf" keyDate="yes">
                <xsl:value-of select="/ArticleSet/Article/Journal/PubDate/Year"/>
                <xsl:if test="/ArticleSet/Article/Journal/PubDate/Month">
                    <xsl:text>-</xsl:text>
                    <xsl:value-of select="/ArticleSet/Article/Journal/PubDate/Month"/>
                </xsl:if>
                <xsl:if test="/ArticleSet/Article/Journal/PubDate/Day">
                    <xsl:text>-</xsl:text>
                    <xsl:value-of select="/ArticleSet/Article/Journal/PubDate/Day"/>
                </xsl:if>
            </dateIssued>
        </originInfo>
    </xsl:template>
    ...
    <xsl:template match="Journal">
        <relatedItem type="host">
            ...
            <part>
                ...
                <xsl:if test="Issue and not(Issue='0')">
                <detail type="issue">
                    <number>
