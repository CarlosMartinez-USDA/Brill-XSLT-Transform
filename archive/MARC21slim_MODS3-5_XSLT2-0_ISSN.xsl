<xsl:stylesheet xmlns="http://www.loc.gov/mods/v3"
	...
	<!-- 
		...
		MARC21slim2MODS3-5 (Revision 2.24) 20150102
		
		Revision 2.25 - Commented out nonSort code - jg 2015/03/03
		Revision 2.24 - Added fields 016, 042, 070, 072, 930, 939, 945, 946, 947, 958, 959; added stripPunctuation test for 'etc.'; added local:stripPunctuation to 264 subfields - jg 2015/01/02
	...
	<xsl:function name="local:stripPunctuation">
		...
		<xsl:variable name="initialTest">
			...
			<xsl:choose>
				...
				<xsl:when test="matches($lastChars,'^([t][c][.])')">true</xsl:when>
	...
	<xsl:template match="marc:record">
		...
		<mods version="3.5">
			...
			<!-- titleInfo type="key" -->
			<xsl:apply-templates
				select="marc:datafield[@tag='222'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'222')]"
				mode="titleInfo"/>
		...
		-->
			...
			<xsl:apply-templates
				select="marc:datafield[@tag='072'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'072')]"
				mode="subject"/>
			...
			<xsl:apply-templates
				...
				mode="classification"/>
			<xsl:apply-templates
				select="marc:datafield[@tag='070'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'070')]"
				mode="classification"/>
			...
			<xsl:apply-templates
				select="marc:datafield[@tag='016'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'016')]"
				mode="id"/>
			<xsl:apply-templates
			...
			<!-- Call templates for extension notes
			<extension>
			<xsl:apply-templates
				select="marc:datafield[@tag='042'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'042')]
				| marc:datafield[@tag='930'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'930')]
				| marc:datafield[@tag='939'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'939')]
				| marc:datafield[@tag='945'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'945')]
				| marc:datafield[@tag='946'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'946')]
				| marc:datafield[@tag='947'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'947')]
				| marc:datafield[@tag='958'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'958')]
				| marc:datafield[@tag='959'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'959')]"
				mode="note"/>
			</extension>  -->
			...
			<recordInfo>
				...
				<recordOrigin>Converted from MARCXML to MODS version 3.5 using
					MARC21slim2MODS3-5_XSL2-0_ISSN.xsl (Revision 2.25 2015/03/03)</recordOrigin>
	...
	<!-- titleInfo Templates: 130 210 222 240 245 246 730 740 -->
	...
	<!-- 222 titleInfo type key-->
	<xsl:template
		match="marc:datafield[@tag='222'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'222')]"
		mode="titleInfo">
		<titleInfo type="alternative" displayLabel="keyTitle">
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
			<title>
				<xsl:value-of select="local:stripPunctuation(local:subfieldSelect(.,'a'))"/>
	...
	<!--	Redundant; duplicates dateIssued element JG 01-02-15
		...
		<xsl:if test="@ind2 ='0' or @ind2 ='1'or @ind2 ='2' or @ind2 ='3'">
			<originInfo>
				...
				<xsl:if test="marc:subfield[@code='b']">
					<publisher>	
						<xsl:value-of select="local:stripPunctuation(local:subfieldSelect(.,'b'))"/>
					</publisher>
				</xsl:if>
					...
					<placeTerm>
						...
						<xsl:choose>
							<xsl:when test="starts-with($str,'[')">
								<xsl:value-of
									select="local:stripPunctuation(local:stripPunctuation(substring(.,1)),']')"
								/>
							</xsl:when>
							<xsl:otherwise>
								<xsl:value-of select="local:stripPunctuation(.)"/>
	...
	<!-- Call template note from 042 -->	
	<xsl:template
		match="marc:datafield[@tag='042'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'042')]"
		mode="note">
		<note type="authenticationCode">
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
			<xsl:call-template name="uri"/>
			<xsl:value-of select="local:subfieldSelect(.,'a')"/>
	...
	<!-- Call template note from 930 -->	
	<xsl:template
		match="marc:datafield[@tag='930'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'930')]"
		mode="note">
			<note type="saleTape930">
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
			<xsl:call-template name="uri"/>
			<xsl:value-of select="local:subfieldSelect(.,'abc')"/>
	...
	<!-- Call template note from 939 -->	
	<xsl:template
		match="marc:datafield[@tag='939'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'939')]"
		mode="note">
		<note type="saleTape939">
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
			<xsl:call-template name="uri"/>
			<xsl:value-of select="local:subfieldSelect(.,'abc')"/>
	...
	<!-- Call template note from 945 -->	
	<xsl:template
		match="marc:datafield[@tag='945'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'945')]"
		mode="note">
		<note type="catalogedInfo">
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
			<xsl:call-template name="uri"/>
			<xsl:value-of select="local:subfieldSelect(.,'abcdefg')"/>
		</note>
	</xsl:template>
	
	<!-- Call template note from 946 -->	
	<xsl:template
		match="marc:datafield[@tag='946'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'946')]"
		mode="note">
	...
	<!-- Call template note from 947 -->	
	<xsl:template
		match="marc:datafield[@tag='947'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'947')]"
		mode="note">
		<note type="collectionSource">
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
			<xsl:call-template name="uri"/>
			<xsl:value-of select="local:subfieldSelect(.,'a')"/>
	...
	<!-- Call template note from 958 -->	
	<xsl:template
		match="marc:datafield[@tag='958'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'958')]"
		mode="note">
		<note type="catalogedInfo">
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
			<xsl:call-template name="uri"/>
			<xsl:value-of select="local:subfieldSelect(.,'abcdefh')"/>
		</note>
	</xsl:template>
	
	<!-- Call template note from 959 -->	
	<xsl:template
		match="marc:datafield[@tag='959'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'959')]"
		mode="note">
		<note type="modifiedInfo">
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
			<xsl:call-template name="uri"/>
			<xsl:value-of select="local:subfieldSelect(.,'aceg')"/>
		</note>
	</xsl:template>
	...
	<!-- 072 subject category codes agricola  -->
	
	<xsl:template
		match="marc:datafield[@tag='072'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'072')]"
		mode="subject">
	...
	<xsl:template
		match="marc:datafield[@tag='070'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'070')]"
		mode="classification">
	...
	<!-- Create Identifiers -->
	<xsl:template
		match="marc:datafield[@tag='016'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'016')]"
		mode="id">
		<xsl:if test="marc:subfield[@code='a' or @code='2']">
			<identifier>
				...
				<!-- create type attribute -->
					<xsl:if test="@ind1='7' and marc:subfield[@code='2']">
						<xsl:attribute name="type">
							<xsl:value-of select="marc:subfield[@code='2']"/>
						</xsl:attribute>
					</xsl:if>
