<xsl:stylesheet xmlns="http://www.loc.gov/mods/v3"
	...
	<!-- 
		...
		MARC21slim2MODS3-5 (Revision 2.25) 20150527
		
		Revision 2.25 - Added displayForm to 100 and 700 - jg 2015/05/27
		...
		-->
			...
			<recordInfo>
				...
				<recordOrigin>Converted from MARCXML to MODS version 3.5 using
					MARC21slim2MODS3-5_XSL2-0.xsl (Revision 2.24 2015/01/02)</recordOrigin>
