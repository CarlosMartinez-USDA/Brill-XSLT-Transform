...
<xsl:stylesheet version="2.0" xmlns="http://www.loc.gov/mods/v3" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <!--    
        File name: 
        pubmed_to_mods-Ullmer.xsl
        
        Created by: 
        Carlos Martinez III, NAL Metadata Librarian, 8/22/2016
        revised 20160824
        ...
        Other information: Using MODS 3.6 as of 20160808, using iso-
		...
		Cleaned up template and added Filename, Created by, Description and Revision history.
		Changed "iso639" to "iso639-3" to include to include German language code DE.  
    ...
    <!--  MAIN ARTICLE TEMPLATE   
        <displayForm>AuthorLastName, AuthorFirstName
            <affiliation>Required if Included: Organization or Agency - Optional: Street, City, State or Province, Zip, Country,- email </affiliation>
        </displayForm>
     -->
    ...
    <xsl:template match="Article">    
        ...
        <genre>article</genre>
        <xsl:call-template name="dateIssued" /> <!-- insert date here, in the following format <originInfo> <dateIssued encoding="w3cdtf" keyDate="yes">YYYY-MM-DD</dateIssued></originInfo>-->
